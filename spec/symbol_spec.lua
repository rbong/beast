...
describe("symbols", function()
	...
	describe("regions", function()
		it("iterates over all regions", function()
			local sym = Symbols:new()
			sym:read_symbols(io.open("./spec/fixtures/regions.sym"))

			local regions = {}
			for region in sym:get_region_symbols(0) do
			...
			regions = {}
			for region in sym:get_region_symbols(1) do
				table.insert(regions, region)
			end
